        ...
        <FadeIn delay={0.2} className="w-full max-w-4xl mb-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div className="glass p-8 rounded-2xl flex flex-col items-center group hover:border-blue-500/30 transition-all duration-300 hover:-translate-y-2">
              <div className="w-14 h-14 rounded-full bg-slate-50/50 flex items-center justify-center mb-6 group-hover:bg-blue-600/10 transition-colors duration-300">
                <Phone className="w-6 h-6 text-blue-600" />
              </div>
              <h3 className="text-slate-900 font-medium text-lg mb-2">Phone</h3>
              <a href={`tel:${siteConfig.phone}`} className="text-slate-600 hover:text-blue-600 transition-colors">
                {siteConfig.phone}
              </a>
            </div>
            ...
            <div className="glass p-8 rounded-2xl flex flex-col items-center group hover:border-blue-500/30 transition-all duration-300 hover:-translate-y-2">
              ...
              <h3 className="text-slate-900 font-medium text-lg mb-2">Email</h3>
              <a href={`mailto:${siteConfig.email}`} className="text-slate-600 hover:text-blue-600 transition-colors break-all">
                {siteConfig.email}
              </a>
            </div>
            ...
            <div className="glass p-8 rounded-2xl flex flex-col items-center group hover:border-blue-500/30 transition-all duration-300 hover:-translate-y-2">
              ...
              <h3 className="text-slate-900 font-medium text-lg mb-2">Location</h3>
            ...
            {socialLinks.map((social) => {
              ...
              return (
                <a 
                  ...
                  className="w-16 h-16 rounded-full glass flex items-center justify-center text-slate-600 hover:text-blue-600 hover:border-blue-500/50 hover:scale-110 transition-all duration-300 group"
